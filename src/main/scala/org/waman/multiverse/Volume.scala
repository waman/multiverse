...
abstract class VolumeUnit(val name: String, val symbol: String, val inRadian: Real)
  extends PhysicalUnit

object VolumeUnit{
  case object CubicYoctoMetre extends VolumeUnit("CubicYoctoMetre", "ym3", r"1e-72")
  case object CubicZeptoMetre extends VolumeUnit("CubicZeptoMetre", "zm3", r"1e-63")
  case object CubicAttoMetre  extends VolumeUnit("CubicAttoMetre" , "am3", r"1e-54")
  case object CubicFemtoMetre extends VolumeUnit("CubicFemtoMetre", "fm3", r"1e-45")
  case object CubicPicoMetre  extends VolumeUnit("CubicPicoMetre" , "pm3", r"1e-36")
  case object CubicNanoMetre  extends VolumeUnit("CubicNanoMetre" , "nm3", r"1e-27")
  case object CubicMicroMetre extends VolumeUnit("CubicMicroMetre", "μm3", r"1e-18")
  case object CubicMilliMetre extends VolumeUnit("CubicMilliMetre", "mm3", r"1e-9")
  case object CubicCentiMetre extends VolumeUnit("CubicCentiMetre", "cm3", r"1e-6")
  case object CubicDeciMetre  extends VolumeUnit("CubicDeciMetre" , "dm3", r"1e-3")
  case object CubicMetre      extends VolumeUnit("CubicMetre"     , "m3" , r"1")
  case object CubicDecaMetre  extends VolumeUnit("CubicDecaMetre" , "dam3", r"1e3")
  case object CubicHectoMetre extends VolumeUnit("CubicHectoMetre", "hm3", r"1e6")
  case object CubicKiloMetre  extends VolumeUnit("CubicKiloMetre" , "km3", r"1e9")
  case object CubicMegaMetre  extends VolumeUnit("CubicMegaMetre" , "Mm3", r"1e18")
  case object CubicGigaMetre  extends VolumeUnit("CubicGigaMetre" , "Gm3", r"1e27")
  case object CubicTeraMetre  extends VolumeUnit("CubicTeraMetre" , "Tm3", r"1e36")
  case object CubicPetaMetre  extends VolumeUnit("CubicPetaMetre" , "Pm3", r"1e45")
  case object CubicExaMetre   extends VolumeUnit("CubicExaMetre"  , "Em3", r"1e54")
  case object CubicZettaMetre extends VolumeUnit("CubicZettaMetre", "Zm3", r"1e63")
  case object CubicYottaMetre extends VolumeUnit("CubicYettaMetre", "Ym3", r"1e72")

  case object YoctoLitre extends VolumeUnit(" YoctoLitre", "yL", r"1e-24")
  case object ZeptoLitre extends VolumeUnit(" ZeptoLitre", "zL", r"1e-21")
  case object AttoLitre  extends VolumeUnit(" AttoLitre" , "aL", r"1e-18")
  case object FemtoLitre extends VolumeUnit(" FemtoLitre", "fL", r"1e-15")
  case object PicoLitre  extends VolumeUnit(" PicoLitre" , "pL", r"1e-12")
  case object NanoLitre  extends VolumeUnit(" NanoLitre" , "nL", r"1e-9")
  case object MicroLitre extends VolumeUnit(" MicroLitre", "μL", r"1e-6")
  case object MilliLitre extends VolumeUnit(" MilliLitre", "mL", r"1e-3")
  case object CentiLitre extends VolumeUnit(" CentiLitre", "cL", r"1e-2")
  case object DeciLitre  extends VolumeUnit(" DeciLitre" , "dL", r"1e-1")
  case object Litre      extends VolumeUnit(" Litre"     , "L" , r"1")
  case object DecaLitre  extends VolumeUnit(" DecaLitre" , "daL", r"1e1")
  case object HectoLitre extends VolumeUnit(" HectoLitre", "hL", r"1e2")
  case object KiloLitre  extends VolumeUnit(" KiloLitre" , "kL", r"1e3")
  case object MegaLitre  extends VolumeUnit(" MegaLitre" , "ML", r"1e6")
  case object GigaLitre  extends VolumeUnit(" GigaLitre" , "GL", r"1e9")
  case object TeraLitre  extends VolumeUnit(" TeraLitre" , "TL", r"1e12")
  case object PetaLitre  extends VolumeUnit(" PetaLitre" , "PL", r"1e15")
  case object ExaLitre   extends VolumeUnit(" ExaLitre"  , "EL", r"1e18")
  case object ZettaLitre extends VolumeUnit(" ZettaLitre", "ZL", r"1e21")
  case object YottaLitre extends VolumeUnit(" YettaLitre", "YL", r"1e24")

  case object Lambda extends VolumeUnit("Lambda", "λ", r"1e-9")
}
