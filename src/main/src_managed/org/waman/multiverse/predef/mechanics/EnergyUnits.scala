...
class DefaultEnergyUnit(val name: String, val symbol: String, val aliases: Seq[String], val intervalInSIUnit: Real) extends EnergyUnit
...
object EnergyUnitObjects{
  ...
  final object rydberg extends DefaultEnergyUnit("rydberg", "Ry", Nil, r"13.6056925330" * electronvolt.intervalInSIUnit) with NotExact
  final object atomic_unit_of_energy extends DefaultEnergyUnit("atomic unit of energy", "E_h", Nil, r"2" * rydberg.intervalInSIUnit) with NotExact
  final object calorie extends DefaultEnergyUnit("calorie", "cal", Seq("cal(IT)", "cal_IT"), r"4.1868")
