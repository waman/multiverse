...
trait EquivalentDosePostfixOps[A]{
  ...
  def microSv : A = equivalentDosePostfixOps(MicroSievert)
...
trait EquivalentDoseDot[A]{
  ...
  def microSievert(dot: Dot): A = equivalentDoseDot(MicroSievert)
  def microSv(dot: Dot): A = equivalentDoseDot(MicroSievert)
  ...
  def microREM(dot: Dot): A = equivalentDoseDot(MicroREM)
  def microRem(dot: Dot): A = equivalentDoseDot(MicroREM)
...
trait EquivalentDosePer[A]{
  ...
  def microSv(per: Per): A = equivalentDosePer(MicroSievert)
