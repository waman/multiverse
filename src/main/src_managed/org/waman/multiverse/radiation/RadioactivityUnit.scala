...
object RadioactivityUnit extends ConstantsDefined[RadioactivityUnit]{
  ...
  case object MicroBecquerel extends IntrinsicRadioactivityUnit("MicroBecquerel", Seq("μBq", "mcBq"), r"1e-6")
  ...
  case object MicroCurie extends IntrinsicRadioactivityUnit("MicroCurie", Seq("μCi", "mcCi"), r"1e-6" * r"3.7e10")
...
trait RadioactivityPostfixOps[A]{
  ...
  def mcBq : A = radioactivityPostfixOps(MicroBecquerel)
  ...
  def mcCi : A = radioactivityPostfixOps(MicroCurie)
...
trait RadioactivityDot[A]{
  ...
  def mcBq(dot: Dot): A = radioactivityDot(MicroBecquerel)
  ...
  def mcCi(dot: Dot): A = radioactivityDot(MicroCurie)
...
trait RadioactivityPer[A]{
  ...
  def mcBq(per: Per): A = radioactivityPer(MicroBecquerel)
  ...
  def mcCi(per: Per): A = radioactivityPer(MicroCurie)
