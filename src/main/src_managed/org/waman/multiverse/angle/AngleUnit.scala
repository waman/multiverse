...
object AngleUnit extends ConstantsDefined[AngleUnit]{
  ...
  case object MicroArcsec extends IntrinsicAngleUnit("MicroArcsec", Seq("microArcsec", "microAs", "μas"), r"1e-6", Arcsec)
...
trait AnglePostfixOps[A]{
  ...
  def microArcsec : A = anglePostfixOps(MicroArcsec)
  def microAs : A = anglePostfixOps(MicroArcsec)
...
trait AngleDot[A]{
  ...
  def microArcsec(dot: Dot): A = angleDot(MicroArcsec)
  def microAs(dot: Dot): A = angleDot(MicroArcsec)
...
trait AnglePer[A]{
  ...
  def microArcsec(per: Per): A = anglePer(MicroArcsec)
  def microAs(per: Per): A = anglePer(MicroArcsec)
