...
trait FrequencyPostfixOps[A]{
  ...
  def microHz : A = frequencyPostfixOps(MicroHeltz)
...
trait FrequencyDot[A]{
  ...
  def microHeltz(dot: Dot): A = frequencyDot(MicroHeltz)
  def microHz(dot: Dot): A = frequencyDot(MicroHeltz)
...
trait FrequencyPer[A]{
  ...
  def microHeltz(per: Per): A = frequencyPer(MicroHeltz)
  def microHz(per: Per): A = frequencyPer(MicroHeltz)
