...
trait LuminousFluxPostfixOps[A]{
  ...
  def microLm : A = luminousFluxPostfixOps(MicroLumen)
...
trait LuminousFluxDot[A]{
  ...
  def microLumen(dot: Dot): A = luminousFluxDot(MicroLumen)
  def microLm(dot: Dot): A = luminousFluxDot(MicroLumen)
...
trait LuminousFluxPer[A]{
  ...
  def microLm(per: Per): A = luminousFluxPer(MicroLumen)
