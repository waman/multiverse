...
sealed trait LuminousIntensityUnit extends PhysicalUnit[LuminousIntensityUnit]
  ...
  override def getSIUnit = org.waman.multiverse.luminous.LuminousIntensityUnit.Candela
...
object LuminousIntensityUnit extends ConstantsDefined[LuminousIntensityUnit]{
  ...
  class IntrinsicLuminousIntensityUnit(val name: String, val symbols: Seq[String], val unitValueInSIUnit: Real)
  ...
  case object MicroCandela extends IntrinsicLuminousIntensityUnit("MicroCandela", Seq("μcd", "mccd"), r"1e-6")
...
trait LuminousIntensityPostfixOps[A]{
  ...
  def mccd : A = luminousIntensityPostfixOps(MicroCandela)
...
trait LuminousIntensityDot[A]{
  ...
  def mccd(dot: Dot): A = luminousIntensityDot(MicroCandela)
...
trait LuminousIntensityPer[A]{
  ...
  def mccd(per: Per): A = luminousIntensityPer(MicroCandela)
