...
trait IlluminancePostfixOps[A]{
  ...
  def microLx : A = illuminancePostfixOps(MicroLux)
...
trait IlluminanceDot[A]{
  ...
  def microLux(dot: Dot): A = illuminanceDot(MicroLux)
  def microLx(dot: Dot): A = illuminanceDot(MicroLux)
...
trait IlluminancePer[A]{
  ...
  def microLux(per: Per): A = illuminancePer(MicroLux)
  def microLx(per: Per): A = illuminancePer(MicroLux)
