...
object AbsorbedDoseUnitObjects{
  ...
  final object gray extends DefaultAbsorbedDoseUnit("gray", "Gy", Nil, 1)
  final object yoctogray extends DefaultAbsorbedDoseUnit("yoctogray", "yGy", Nil, 1 * r"1e-24")
  final object zeptogray extends DefaultAbsorbedDoseUnit("zeptogray", "zGy", Nil, 1 * r"1e-21")
  final object attogray extends DefaultAbsorbedDoseUnit("attogray", "aGy", Nil, 1 * r"1e-18")
  final object femtogray extends DefaultAbsorbedDoseUnit("femtogray", "fGy", Nil, 1 * r"1e-15")
  final object picogray extends DefaultAbsorbedDoseUnit("picogray", "pGy", Nil, 1 * r"1e-12")
  final object nanogray extends DefaultAbsorbedDoseUnit("nanogray", "nGy", Nil, 1 * r"1e-9")
  final object microgray extends DefaultAbsorbedDoseUnit("microgray", "μGy", Seq("mcGy"), 1 * r"1e-6")
  final object milligray extends DefaultAbsorbedDoseUnit("milligray", "mGy", Nil, 1 * r"1e-3")
  final object centigray extends DefaultAbsorbedDoseUnit("centigray", "cGy", Nil, 1 * r"1e-2")
  final object decigray extends DefaultAbsorbedDoseUnit("decigray", "dGy", Nil, 1 * r"1e-1")
  final object decagray extends DefaultAbsorbedDoseUnit("decagray", "daGy", Nil, 1 * r"1e1")
  final object hectogray extends DefaultAbsorbedDoseUnit("hectogray", "hGy", Nil, 1 * r"1e2")
  final object kilogray extends DefaultAbsorbedDoseUnit("kilogray", "kGy", Seq("KGy"), 1 * r"1e3")
  final object megagray extends DefaultAbsorbedDoseUnit("megagray", "MGy", Nil, 1 * r"1e6")
  final object gigagray extends DefaultAbsorbedDoseUnit("gigagray", "GGy", Nil, 1 * r"1e9")
  final object teragray extends DefaultAbsorbedDoseUnit("teragray", "TGy", Nil, 1 * r"1e12")
  final object petagray extends DefaultAbsorbedDoseUnit("petagray", "PGy", Nil, 1 * r"1e15")
  final object exagray extends DefaultAbsorbedDoseUnit("exagray", "EGy", Nil, 1 * r"1e18")
  final object zettagray extends DefaultAbsorbedDoseUnit("zettagray", "ZGy", Nil, 1 * r"1e21")
  final object yottagray extends DefaultAbsorbedDoseUnit("yottagray", "YGy", Nil, 1 * r"1e24")
}
