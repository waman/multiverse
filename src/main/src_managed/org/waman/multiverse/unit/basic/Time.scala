...
object TimeUnitObjects{
  ...
  final object month extends DefaultTimeUnit("month", "mo", Nil, r"30.436875" * day.interval)
  ...
  final object year extends DefaultTimeUnit("year", "yr", Seq("y", "a"), r"365.2425" * day.interval)
  ...
  final object decade extends DefaultTimeUnit("decade", "dec", Nil, r"10" * `year(gregorian)`.interval)
  ...
  final object century extends DefaultTimeUnit("century", "century", Nil, r"100" * `year(gregorian)`.interval)
