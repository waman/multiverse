...
object VolumeUnitObjects{
  ...
  final case object cubic_yoctometre extends DefaultVolumeUnit("cubic yoctometre", "ym³", Seq("ym3"), LengthUnitObjects.yoctometre.interval**3)
  final case object cubic_zeptometre extends DefaultVolumeUnit("cubic zeptometre", "zm³", Seq("zm3"), LengthUnitObjects.zeptometre.interval**3)
  final case object cubic_attometre extends DefaultVolumeUnit("cubic attometre", "am³", Seq("am3"), LengthUnitObjects.attometre.interval**3)
  final case object cubic_femtometre extends DefaultVolumeUnit("cubic femtometre", "fm³", Seq("fm3"), LengthUnitObjects.femtometre.interval**3)
  final case object cubic_picometre extends DefaultVolumeUnit("cubic picometre", "pm³", Seq("pm3"), LengthUnitObjects.picometre.interval**3)
  final case object cubic_nanometre extends DefaultVolumeUnit("cubic nanometre", "nm³", Seq("nm3"), LengthUnitObjects.nanometre.interval**3)
  final case object cubic_micrometre extends DefaultVolumeUnit("cubic micrometre", "μm³", Seq("μm3", "mcm³", "mcm3"), LengthUnitObjects.micrometre.interval**3)
  final case object cubic_millimetre extends DefaultVolumeUnit("cubic millimetre", "mm³", Seq("mm3"), LengthUnitObjects.millimetre.interval**3)
  final case object cubic_centimetre extends DefaultVolumeUnit("cubic centimetre", "cm³", Seq("cm3"), LengthUnitObjects.centimetre.interval**3)
  final case object cubic_decimetre extends DefaultVolumeUnit("cubic decimetre", "dm³", Seq("dm3"), LengthUnitObjects.decimetre.interval**3)
  final case object cubic_decametre extends DefaultVolumeUnit("cubic decametre", "dam³", Seq("dam3"), LengthUnitObjects.decametre.interval**3)
  final case object cubic_hectometre extends DefaultVolumeUnit("cubic hectometre", "hm³", Seq("hm3"), LengthUnitObjects.hectometre.interval**3)
  final case object cubic_kilometre extends DefaultVolumeUnit("cubic kilometre", "km³", Seq("km3", "Km³", "Km3"), LengthUnitObjects.kilometre.interval**3)
  final case object cubic_megametre extends DefaultVolumeUnit("cubic megametre", "Mm³", Seq("Mm3"), LengthUnitObjects.megametre.interval**3)
  final case object cubic_gigametre extends DefaultVolumeUnit("cubic gigametre", "Gm³", Seq("Gm3"), LengthUnitObjects.gigametre.interval**3)
  final case object cubic_terametre extends DefaultVolumeUnit("cubic terametre", "Tm³", Seq("Tm3"), LengthUnitObjects.terametre.interval**3)
  final case object cubic_petametre extends DefaultVolumeUnit("cubic petametre", "Pm³", Seq("Pm3"), LengthUnitObjects.petametre.interval**3)
  final case object cubic_exametre extends DefaultVolumeUnit("cubic exametre", "Em³", Seq("Em3"), LengthUnitObjects.exametre.interval**3)
  final case object cubic_zettametre extends DefaultVolumeUnit("cubic zettametre", "Zm³", Seq("Zm3"), LengthUnitObjects.zettametre.interval**3)
  final case object cubic_yottametre extends DefaultVolumeUnit("cubic yottametre", "Ym³", Seq("Ym3"), LengthUnitObjects.yottametre.interval**3)
  final case object litre extends DefaultVolumeUnit("litre", "L", Nil, r"1e-3")
  final case object yoctolitre extends DefaultVolumeUnit("yoctolitre", "yL", Nil, r"1e-3" * r"1e-24")
  final case object zeptolitre extends DefaultVolumeUnit("zeptolitre", "zL", Nil, r"1e-3" * r"1e-21")
  final case object attolitre extends DefaultVolumeUnit("attolitre", "aL", Nil, r"1e-3" * r"1e-18")
  final case object femtolitre extends DefaultVolumeUnit("femtolitre", "fL", Nil, r"1e-3" * r"1e-15")
  final case object picolitre extends DefaultVolumeUnit("picolitre", "pL", Nil, r"1e-3" * r"1e-12")
  final case object nanolitre extends DefaultVolumeUnit("nanolitre", "nL", Nil, r"1e-3" * r"1e-9")
  final case object microlitre extends DefaultVolumeUnit("microlitre", "μL", Seq("mcL"), r"1e-3" * r"1e-6")
  final case object millilitre extends DefaultVolumeUnit("millilitre", "mL", Nil, r"1e-3" * r"1e-3")
  final case object centilitre extends DefaultVolumeUnit("centilitre", "cL", Nil, r"1e-3" * r"1e-2")
  final case object decilitre extends DefaultVolumeUnit("decilitre", "dL", Nil, r"1e-3" * r"1e-1")
  final case object decalitre extends DefaultVolumeUnit("decalitre", "daL", Nil, r"1e-3" * r"1e1")
  final case object hectolitre extends DefaultVolumeUnit("hectolitre", "hL", Nil, r"1e-3" * r"1e2")
  final case object kilolitre extends DefaultVolumeUnit("kilolitre", "kL", Seq("KL"), r"1e-3" * r"1e3")
  final case object megalitre extends DefaultVolumeUnit("megalitre", "ML", Nil, r"1e-3" * r"1e6")
  final case object gigalitre extends DefaultVolumeUnit("gigalitre", "GL", Nil, r"1e-3" * r"1e9")
  final case object teralitre extends DefaultVolumeUnit("teralitre", "TL", Nil, r"1e-3" * r"1e12")
  final case object petalitre extends DefaultVolumeUnit("petalitre", "PL", Nil, r"1e-3" * r"1e15")
  final case object exalitre extends DefaultVolumeUnit("exalitre", "EL", Nil, r"1e-3" * r"1e18")
  final case object zettalitre extends DefaultVolumeUnit("zettalitre", "ZL", Nil, r"1e-3" * r"1e21")
  final case object yottalitre extends DefaultVolumeUnit("yottalitre", "YL", Nil, r"1e-3" * r"1e24")
  final case object lambda extends DefaultVolumeUnit("lambda", "λ", Nil, r"1e-9")
  final case object cubic_inch extends DefaultVolumeUnit("cubic inch", "in³", Seq("in3", "cu_in"), LengthUnitObjects.inch.interval**3)
  final case object cubic_foot extends DefaultVolumeUnit("cubic foot", "ft³", Seq("ft3", "cu_ft"), LengthUnitObjects.foot.interval**3)
  final case object cubic_yard extends DefaultVolumeUnit("cubic yard", "yd³", Seq("yd3", "cu_yd"), LengthUnitObjects.yard.interval**3)
  final case object cubic_fathom extends DefaultVolumeUnit("cubic fathom", "ftm³", Seq("ftm3", "cu_fm"), LengthUnitObjects.fathom.interval**3)
  final case object cubic_mile extends DefaultVolumeUnit("cubic mile", "mi³", Seq("mi3", "cu_mi"), LengthUnitObjects.mile.interval**3)
  final case object board_foot extends DefaultVolumeUnit("board foot", "fbm", Nil, r"144" * cubic_inch.interval)
  final case object gallon_beer extends DefaultVolumeUnit("gallon_beer", "beer_gal", Nil, r"282" * cubic_inch.interval)
  final case object perch extends DefaultVolumeUnit("perch", "per", Nil, r"33"/r"2" * r"3"/r"2" * cubic_foot.interval)
  final case object minim extends DefaultVolumeUnit("minim", "minim", Nil, `minim(US)`.interval)
  ...
  final case object `pint(imp)` extends DefaultVolumeUnit("pint(imp)", "pt(imp)", Nil, r"1"/r"8" * `gallon(imp)`.interval)
  final case object quart extends DefaultVolumeUnit("quart", "qt", Nil, 1)
  final case object `quart(US_fl)` extends DefaultVolumeUnit("quart(US_fl)", "qt(US_fl)", Nil, r"1"/r"4" * `gallon(US_fl)`.interval)
  final case object `quart(US_dry)` extends DefaultVolumeUnit("quart(US_dry)", "qt(US_dry)", Nil, r"1"/r"4" * `gallon(US_dry)`.interval)
  ...
  final case object hogshead extends DefaultVolumeUnit("hogshead", "hhd", Nil, 1)
  final case object `hogshead(US)` extends DefaultVolumeUnit("hogshead(US)", "hhd(US)", Nil, r"2" * `barrel(US_fl)`.interval)
  final case object `hogshead(imp)` extends DefaultVolumeUnit("hogshead(imp)", "hhd(imp)", Nil, r"2" * `barrel(imp)`.interval)
  final case object fluid_dram extends DefaultVolumeUnit("fluid dram", "fl_dr", Nil, 1)
  final case object `fluid_dram(US)` extends DefaultVolumeUnit("fluid dram(US)", "fl_dr(US)", Nil, r"1"/r"8" * `fluid_ounce(US)`.interval)
  final case object `fluid_dram(imp)` extends DefaultVolumeUnit("fluid dram(imp)", "fl_dr(imp)", Nil, r"1"/r"8" * `fluid_ounce(imp)`.interval)
  final case object fluid_scruple extends DefaultVolumeUnit("fluid scruple", "fl_s", Nil, r"1"/r"24" * `fluid_ounce(imp)`.interval)
  final case object bucket extends DefaultVolumeUnit("bucket", "bkt", Nil, r"4" * `gallon(imp)`.interval)
}
