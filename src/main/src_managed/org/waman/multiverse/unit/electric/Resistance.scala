...
object ResistanceUnitObjects{
  ...
  final object ohm extends DefaultResistanceUnit("ohm", "Ω", Seq("ohm"), 1)
  final object yoctoohm extends DefaultResistanceUnit("yoctoohm", "yΩ", Seq("yohm"), 1 * r"1e-24")
  final object zeptoohm extends DefaultResistanceUnit("zeptoohm", "zΩ", Seq("zohm"), 1 * r"1e-21")
  final object attoohm extends DefaultResistanceUnit("attoohm", "aΩ", Seq("aohm"), 1 * r"1e-18")
  final object femtoohm extends DefaultResistanceUnit("femtoohm", "fΩ", Seq("fohm"), 1 * r"1e-15")
  final object picoohm extends DefaultResistanceUnit("picoohm", "pΩ", Seq("pohm"), 1 * r"1e-12")
  final object nanoohm extends DefaultResistanceUnit("nanoohm", "nΩ", Seq("nohm"), 1 * r"1e-9")
  final object microohm extends DefaultResistanceUnit("microohm", "μΩ", Seq("μohm", "mcΩ", "mcohm"), 1 * r"1e-6")
  final object milliohm extends DefaultResistanceUnit("milliohm", "mΩ", Seq("mohm"), 1 * r"1e-3")
  final object centiohm extends DefaultResistanceUnit("centiohm", "cΩ", Seq("cohm"), 1 * r"1e-2")
  final object deciohm extends DefaultResistanceUnit("deciohm", "dΩ", Seq("dohm"), 1 * r"1e-1")
  final object decaohm extends DefaultResistanceUnit("decaohm", "daΩ", Seq("daohm"), 1 * r"1e1")
  final object hectoohm extends DefaultResistanceUnit("hectoohm", "hΩ", Seq("hohm"), 1 * r"1e2")
  final object kiloohm extends DefaultResistanceUnit("kiloohm", "kΩ", Seq("kohm", "KΩ", "Kohm"), 1 * r"1e3")
  final object megaohm extends DefaultResistanceUnit("megaohm", "MΩ", Seq("Mohm"), 1 * r"1e6")
  final object gigaohm extends DefaultResistanceUnit("gigaohm", "GΩ", Seq("Gohm"), 1 * r"1e9")
  final object teraohm extends DefaultResistanceUnit("teraohm", "TΩ", Seq("Tohm"), 1 * r"1e12")
  final object petaohm extends DefaultResistanceUnit("petaohm", "PΩ", Seq("Pohm"), 1 * r"1e15")
  final object exaohm extends DefaultResistanceUnit("exaohm", "EΩ", Seq("Eohm"), 1 * r"1e18")
  final object zettaohm extends DefaultResistanceUnit("zettaohm", "ZΩ", Seq("Zohm"), 1 * r"1e21")
  final object yottaohm extends DefaultResistanceUnit("yottaohm", "YΩ", Seq("Yohm"), 1 * r"1e24")
