...
object TemperatureUnitObjects{
  ...
  final object attokelvin extends DefaultTemperatureUnit("attokelvin", "aK", Nil, r"0", r"1" * r"1e-18")
  final object femtokelvin extends DefaultTemperatureUnit("femtokelvin", "fK", Nil, r"0", r"1" * r"1e-15")
  final object picokelvin extends DefaultTemperatureUnit("picokelvin", "pK", Nil, r"0", r"1" * r"1e-12")
  final object nanokelvin extends DefaultTemperatureUnit("nanokelvin", "nK", Nil, r"0", r"1" * r"1e-9")
  final object microkelvin extends DefaultTemperatureUnit("microkelvin", "μK", Seq("mcK"), r"0", r"1" * r"1e-6")
  final object millikelvin extends DefaultTemperatureUnit("millikelvin", "mK", Nil, r"0", r"1" * r"1e-3")
  final object centikelvin extends DefaultTemperatureUnit("centikelvin", "cK", Nil, r"0", r"1" * r"1e-2")
  final object decikelvin extends DefaultTemperatureUnit("decikelvin", "dK", Nil, r"0", r"1" * r"1e-1")
  final object decakelvin extends DefaultTemperatureUnit("decakelvin", "daK", Nil, r"0", r"1" * r"1e1")
  final object hectokelvin extends DefaultTemperatureUnit("hectokelvin", "hK", Nil, r"0", r"1" * r"1e2")
  final object kilokelvin extends DefaultTemperatureUnit("kilokelvin", "kK", Seq("KK"), r"0", r"1" * r"1e3")
  final object megakelvin extends DefaultTemperatureUnit("megakelvin", "MK", Nil, r"0", r"1" * r"1e6")
  final object gigakelvin extends DefaultTemperatureUnit("gigakelvin", "GK", Nil, r"0", r"1" * r"1e9")
  final object terakelvin extends DefaultTemperatureUnit("terakelvin", "TK", Nil, r"0", r"1" * r"1e12")
  final object petakelvin extends DefaultTemperatureUnit("petakelvin", "PK", Nil, r"0", r"1" * r"1e15")
  final object exakelvin extends DefaultTemperatureUnit("exakelvin", "EK", Nil, r"0", r"1" * r"1e18")
  final object zettakelvin extends DefaultTemperatureUnit("zettakelvin", "ZK", Nil, r"0", r"1" * r"1e21")
  final object yottakelvin extends DefaultTemperatureUnit("yottakelvin", "YK", Nil, r"0", r"1" * r"1e24")
  final object celsius extends DefaultTemperatureUnit("celsius", "°C", Seq("degC", "℃"), r"273.15", r"1")
  final object fahrenheit extends DefaultTemperatureUnit("fahrenheit", "°F", Seq("degF", "℉"), r"273.15" - r"5"/r"9" * r"32", r"5"/r"9")
  final object rankine extends DefaultTemperatureUnit("rankine", "°R", Seq("degR"), r"0", r"5"/r"9")
