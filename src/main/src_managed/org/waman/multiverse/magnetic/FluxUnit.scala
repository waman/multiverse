...
trait FluxPostfixOps[A]{
  ...
  def microWb : A = fluxPostfixOps(MicroWeber)
  ...
  def microMx : A = fluxPostfixOps(MicroMaxwell)
...
trait FluxDot[A]{
  ...
  def microWeber(dot: Dot): A = fluxDot(MicroWeber)
  def microWb(dot: Dot): A = fluxDot(MicroWeber)
  ...
  def microMaxwell(dot: Dot): A = fluxDot(MicroMaxwell)
  def microMx(dot: Dot): A = fluxDot(MicroMaxwell)
...
trait FluxPer[A]{
  ...
  def microWb(per: Per): A = fluxPer(MicroWeber)
  ...
  def microMx(per: Per): A = fluxPer(MicroMaxwell)
