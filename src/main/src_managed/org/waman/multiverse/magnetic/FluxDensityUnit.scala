...
object FluxDensityUnit extends ConstantsDefined[FluxDensityUnit]{
  ...
  case object MicroTesla extends IntrinsicFluxDensityUnit("MicroTesla", Seq("μT", "mcT"), r"1e-6")
  ...
  case object MicroGauss extends IntrinsicFluxDensityUnit("MicroGauss", Seq("μG", "mcG"), r"1e-6" * r"1e-4")
...
trait FluxDensityPostfixOps[A]{
  ...
  def mcT : A = fluxDensityPostfixOps(MicroTesla)
  ...
  def mcG : A = fluxDensityPostfixOps(MicroGauss)
...
trait FluxDensityDot[A]{
  ...
  def mcT(dot: Dot): A = fluxDensityDot(MicroTesla)
  ...
  def mcG(dot: Dot): A = fluxDensityDot(MicroGauss)
...
trait FluxDensityPer[A]{
  ...
  def mcT(per: Per): A = fluxDensityPer(MicroTesla)
  ...
  def mcG(per: Per): A = fluxDensityPer(MicroGauss)
