...
object VolumeUnit extends ConstantsDefined[VolumeUnit]{
  ...
  case object DecaCubicMetre extends IntrinsicVolumeUnit("DecaCubicMetre", Seq("dam3"), r"1e-1"**3)
    
  case object HectoCubicMetre extends IntrinsicVolumeUnit("HectoCubicMetre", Seq("hm3"), r"1e-2"**3)
    
  case object KiloCubicMetre extends IntrinsicVolumeUnit("KiloCubicMetre", Seq("km3"), r"1e-3"**3)
    
  case object MegaCubicMetre extends IntrinsicVolumeUnit("MegaCubicMetre", Seq("Mm3"), r"1e-6"**3)
    
  case object GigaCubicMetre extends IntrinsicVolumeUnit("GigaCubicMetre", Seq("Gm3"), r"1e-9"**3)
    
  case object TeraCubicMetre extends IntrinsicVolumeUnit("TeraCubicMetre", Seq("Tm3"), r"1e-12"**3)
    
  case object PetaCubicMetre extends IntrinsicVolumeUnit("PetaCubicMetre", Seq("Pm3"), r"1e-15"**3)
    
  case object ExaCubicMetre extends IntrinsicVolumeUnit("ExaCubicMetre", Seq("Em3"), r"1e-18"**3)
    
  case object ZettaCubicMetre extends IntrinsicVolumeUnit("ZettaCubicMetre", Seq("Zm3"), r"1e-21"**3)
    
  case object YottaCubicMetre extends IntrinsicVolumeUnit("YottaCubicMetre", Seq("Ym3"), r"1e-24"**3)
  ...
  case object DecaLitre extends IntrinsicVolumeUnit("DecaLitre", Seq("daL"), r"1e-1" * r"1e-3")
    
  case object HectoLitre extends IntrinsicVolumeUnit("HectoLitre", Seq("hL"), r"1e-2" * r"1e-3")
    
  case object KiloLitre extends IntrinsicVolumeUnit("KiloLitre", Seq("kL"), r"1e-3" * r"1e-3")
    
  case object MegaLitre extends IntrinsicVolumeUnit("MegaLitre", Seq("ML"), r"1e-6" * r"1e-3")
    
  case object GigaLitre extends IntrinsicVolumeUnit("GigaLitre", Seq("GL"), r"1e-9" * r"1e-3")
    
  case object TeraLitre extends IntrinsicVolumeUnit("TeraLitre", Seq("TL"), r"1e-12" * r"1e-3")
    
  case object PetaLitre extends IntrinsicVolumeUnit("PetaLitre", Seq("PL"), r"1e-15" * r"1e-3")
    
  case object ExaLitre extends IntrinsicVolumeUnit("ExaLitre", Seq("EL"), r"1e-18" * r"1e-3")
    
  case object ZettaLitre extends IntrinsicVolumeUnit("ZettaLitre", Seq("ZL"), r"1e-21" * r"1e-3")
    
  case object YottaLitre extends IntrinsicVolumeUnit("YottaLitre", Seq("YL"), r"1e-24" * r"1e-3")
  ...
  case object Barrel_US_dry extends IntrinsicVolumeUnit("Barrel_US_dry", Seq("bl(US_dry)"), r"2150.42", CubicInch)
    
  case object Bushel_US_dry_level extends IntrinsicVolumeUnit("Bushel_US_dry_level", Seq("bu(US_lvl)"), 105, Quart_US_dry)
  ...
  private[VolumeUnit]
  class AreaDotLengthUnit(val firstUnit: AreaUnit, val secondUnit: LengthUnit)
  ...
  def apply(unit1: AreaUnit, unit2: LengthUnit): VolumeUnit =
    new AreaDotLengthUnit(unit1, unit2)
}
