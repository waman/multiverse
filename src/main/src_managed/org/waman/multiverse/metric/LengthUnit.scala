...
object LengthUnit extends ConstantsDefined[LengthUnit]{
  ...
  case object MicroMetre extends IntrinsicLengthUnit("MicroMetre", Seq("microMetre", "μm"), r"1e-6")
  ...
  case object DecaMetre extends IntrinsicLengthUnit("DecaMetre", Seq("dam"), r"1e-1")
    
  case object HectoMetre extends IntrinsicLengthUnit("HectoMetre", Seq("hm"), r"1e-2")
    
  case object KiloMetre extends IntrinsicLengthUnit("KiloMetre", Seq("km"), r"1e-3")
    
  case object MegaMetre extends IntrinsicLengthUnit("MegaMetre", Seq("Mm"), r"1e-6")
    
  case object GigaMetre extends IntrinsicLengthUnit("GigaMetre", Seq("Gm"), r"1e-9")
    
  case object TeraMetre extends IntrinsicLengthUnit("TeraMetre", Seq("Tm"), r"1e-12")
    
  case object PetaMetre extends IntrinsicLengthUnit("PetaMetre", Seq("Pm"), r"1e-15")
    
  case object ExaMetre extends IntrinsicLengthUnit("ExaMetre", Seq("Em"), r"1e-18")
    
  case object ZettaMetre extends IntrinsicLengthUnit("ZettaMetre", Seq("Zm"), r"1e-21")
    
  case object YottaMetre extends IntrinsicLengthUnit("YottaMetre", Seq("Ym"), r"1e-24")
    
  case object Micron extends IntrinsicLengthUnit("Micron", Seq("µ", "micron"), r"1e-6")
    
  case object Angstrom extends IntrinsicLengthUnit("Angstrom", Seq("Å", "angstrom"), r"1e-10")
