...
object AreaUnit extends ConstantsDefined[AreaUnit]{
  ...
  case object SquareYoctoMetre extends IntrinsicAreaUnit("SquareYoctoMetre", Seq("ym2"), r"1e-24"**2)
  case object SquareZeptoMetre extends IntrinsicAreaUnit("SquareZeptoMetre", Seq("zm2"), r"1e-21"**2)
  case object SquareAttoMetre extends IntrinsicAreaUnit("SquareAttoMetre", Seq("am2"), r"1e-18"**2)
  case object SquareFemtoMetre extends IntrinsicAreaUnit("SquareFemtoMetre", Seq("fm2"), r"1e-15"**2)
  case object SquarePicoMetre extends IntrinsicAreaUnit("SquarePicoMetre", Seq("pm2"), r"1e-12"**2)
  case object SquareNanoMetre extends IntrinsicAreaUnit("SquareNanoMetre", Seq("nm2"), r"1e-9"**2)
  case object SquareMicroMetre extends IntrinsicAreaUnit("SquareMicroMetre", Seq("μm2", "mcm2"), r"1e-6"**2)
  case object SquareMilliMetre extends IntrinsicAreaUnit("SquareMilliMetre", Seq("mm2"), r"1e-3"**2)
  case object SquareCentiMetre extends IntrinsicAreaUnit("SquareCentiMetre", Seq("cm2"), r"1e-2"**2)
  case object SquareDeciMetre extends IntrinsicAreaUnit("SquareDeciMetre", Seq("dm2"), r"1e-1"**2)
  case object SquareMetre extends IntrinsicAreaUnit("SquareMetre", Seq("m2"), r"1"**2)
  case object SquareDecaMetre extends IntrinsicAreaUnit("SquareDecaMetre", Seq("dam2"), r"1e1"**2)
  case object SquareHectoMetre extends IntrinsicAreaUnit("SquareHectoMetre", Seq("hm2"), r"1e2"**2)
  case object SquareKiloMetre extends IntrinsicAreaUnit("SquareKiloMetre", Seq("km2"), r"1e3"**2)
  case object SquareMegaMetre extends IntrinsicAreaUnit("SquareMegaMetre", Seq("Mm2"), r"1e6"**2)
  case object SquareGigaMetre extends IntrinsicAreaUnit("SquareGigaMetre", Seq("Gm2"), r"1e9"**2)
  case object SquareTeraMetre extends IntrinsicAreaUnit("SquareTeraMetre", Seq("Tm2"), r"1e12"**2)
  case object SquarePetaMetre extends IntrinsicAreaUnit("SquarePetaMetre", Seq("Pm2"), r"1e15"**2)
  case object SquareExaMetre extends IntrinsicAreaUnit("SquareExaMetre", Seq("Em2"), r"1e18"**2)
  case object SquareZettaMetre extends IntrinsicAreaUnit("SquareZettaMetre", Seq("Zm2"), r"1e21"**2)
  case object SquareYottaMetre extends IntrinsicAreaUnit("SquareYottaMetre", Seq("Ym2"), r"1e24"**2)
  ...
  case object MicroBarn extends IntrinsicAreaUnit("MicroBarn", Seq("μb", "mcb"), r"1e-6" * r"1e-28")
...
trait AreaPostfixOps[A]{
  ...
  def mcm2 : A = areaPostfixOps(SquareMicroMetre)
  ...
  def mcb : A = areaPostfixOps(MicroBarn)
...
trait AreaDot[A]{
  ...
  def mcm2(dot: Dot): A = areaDot(SquareMicroMetre)
  ...
  def mcb(dot: Dot): A = areaDot(MicroBarn)
...
trait AreaPer[A]{
  ...
  def mcm2(per: Per): A = areaPer(SquareMicroMetre)
  ...
  def mcb(per: Per): A = areaPer(MicroBarn)
