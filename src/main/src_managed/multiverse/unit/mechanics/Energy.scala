...
import multiverse.unit.radioactivity.AbsorbedDoseUnit


import multiverse.unit.thermodynamics.AbsoluteTemperatureUnit


import multiverse.unit.thermodynamics.Entropy
...
class Energy[A: Fractional](val value: A, val unit: EnergyUnit)
  ...
  import multiverse.unit.thermodynamics.AbsoluteTemperature
  import multiverse.unit.thermodynamics.AbsoluteTemperatureUnitObjects
  ...
  import multiverse.unit.basic.MassUnitObjects
...
object EnergyUnitObjects{
  ...
  import multiverse.unit.Constants
  import multiverse.unit.mechanics.PowerUnitObjects._
  import multiverse.unit.basic.TimeUnitObjects._
  import multiverse.unit.basic.VolumeUnitObjects._
  import multiverse.unit.fluid.PressureUnitObjects._
