...
object ElectricalConductanceUnitObjects{
  ...
  final case object microsiemens extends DefaultElectricalConductanceUnit("microsiemens", "μS", Seq("μmho", "μ℧", "mcS", "mcmho", "mc℧"), r"1e-6")
  ...
  final case object kilosiemens extends DefaultElectricalConductanceUnit("kilosiemens", "kS", Seq("kmho", "k℧", "KS", "Kmho", "K℧"), r"1e3")
