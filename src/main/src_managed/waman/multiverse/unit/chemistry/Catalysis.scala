package waman.multiverse.unit.chemistry
...
object CatalysisUnitObjects{
  ...
  import waman.multiverse.unit.chemistry.AmountOfSubstanceUnitObjects._
  ...
  final case object enzyme_unit extends DefaultCatalysisUnit("enzyme unit", "U", Seq("IU"), micromole.interval / minute.interval)
}
