    ...
    "3.0 <<flux unit>> should be converted to the equivalent value in Weber" in {
      ...
      val conversions =
        Table(
          ...
          (Seq(3.0.microWeber, 3.0 microWeber, 3.0 (microWeber)), 3e-6),
          (Seq(3.0.microWb, 3.0 microWb, 3.0 (microWb)), 3e-6),
          ...
          (Seq(3.0.microMaxwell, 3.0 microMaxwell, 3.0 (microMaxwell)), 3e-14),
          (Seq(3.0.microMx, 3.0 microMx, 3.0 (microMx)), 3e-14),
    ...
    "3.0 Wb should be converted to the equivalent value in other flux units" in {
      ...
      val conversions =
        Table(
          ...
          (Seq(q.microWeber, q microWeber, q(microWeber)), 3e6),
          (Seq(q.microWb, q microWb, q(microWb)), 3e6),
          ...
          (Seq(q.microMaxwell, q microMaxwell, q(microMaxwell)), 3e14),
          (Seq(q.microMx, q microMx, q(microMx)), 3e14),
