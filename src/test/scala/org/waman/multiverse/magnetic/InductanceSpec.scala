    ...
    "3.0 <<inductance unit>> should be converted to the equivalent value in Henry" in {
      ...
      val conversions =
        Table(
          ...
          (Seq(3.0.microHenry, 3.0 microHenry, 3.0 (microHenry)), 3e-6),
          (Seq(3.0.microH, 3.0 microH, 3.0 (microH)), 3e-6),
    ...
    "3.0 H should be converted to the equivalent value in other inductance units" in {
      ...
      val conversions =
        Table(
          ...
          (Seq(q.microHenry, q microHenry, q(microHenry)), 3e6),
          (Seq(q.microH, q microH, q(microH)), 3e6),
