  ...
  "3.0 <<luminous intensity unit>> should be converted to the equivalent value in candera" in {
    ...
    val conversions =
      Table(
        ...
        (Seq(3.0.microCandela, 3.0 microCandela, 3.0 (microCandela)), 3e-6),
        (Seq(3.0.microCd, 3.0 microCd, 3.0 (microCd)), 3e-6),
  ...
  "3.0 cd should be converted to the equivalent value in other luminous intensity units" in {
    ...
    val conversions =
      Table(
        ...
        (Seq(q.microCandela, q microCandela, q (microCandela)), 3e6),
        (Seq(q.microCd, q microCd, q (microCd)), 3e6),
