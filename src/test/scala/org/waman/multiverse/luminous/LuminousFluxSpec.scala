  ...
  "3.0 <<luminous flux unit>> should be converted to the equivalent value in lumen" in {
    ...
    val conversions =
      Table(
        ...
        (Seq(3.0.microLumen, 3.0 microLumen, 3.0 (microLumen)), 3e-6),
        (Seq(3.0.microLm, 3.0 microLm, 3.0 (microLm)), 3e-6),
  ...
  "3.0 lm should be converted to the equivalent value in other luminus flux units" in {
    ...
    val conversions =
      Table(
        ...
        (Seq(q.microLumen, q microLumen, q (microLumen)), 3e6),
        (Seq(q.microLm, q microLm, q (microLm)), 3e6),
