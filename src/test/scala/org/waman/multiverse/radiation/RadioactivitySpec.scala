  ...
  "3.0 <<radioactivity unit>> should be converted to the equivalent value in Becquerel" in {
    ...
    val conversions =
      Table(
        ...
        (Seq(3.0.microBecquerel, 3.0 microBecquerel, 3.0 (microBecquerel)), 3e-6),
        (Seq(3.0.microBq, 3.0 microBq, 3.0 (microBq)), 3e-6),
        ...
        (Seq(3.0.microCurie, 3.0 microCurie, 3.0 (microCurie)), 3.0 * 3.7e4),
        (Seq(3.0.microCi, 3.0 microCi, 3.0 (microCi)), 3.0 * 3.7e4),
