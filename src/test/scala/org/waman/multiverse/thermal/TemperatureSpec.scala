    ...
    "3.0 <<temperature unit>> should be converted to the equivalent value in Kelvin" in {
      ...
      val conversions =
        Table(
          ...
          (Seq(3.0.microKelvin, 3.0 microKelvin, 3.0 (microKelvin)), 3e-6),
          (Seq(3.0.microK, 3.0 microK, 3.0 (microK)), 3e-6),
    ...
    "3.0 K should be converted to the equivalent value in other temperature units" in {
      ...
      val conversions =
        Table(
          ...
          (Seq(q.microKelvin, q microKelvin, q(microKelvin)), 3e6),
          (Seq(q.microK, q microK, q(microK)), 3e6),
