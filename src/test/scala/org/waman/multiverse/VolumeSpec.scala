  ...
  "Tests where converting cubic metre unit to other units like 3.0 m3 => 3.0 * 1e-6 km3" in {
    val conversions =
      Table(
        ...
        (Seq(three_m3.yL, three_m3 yL, three_m3 (yL)), 3e27),
        (Seq(three_m3.zL, three_m3 zL, three_m3 (zL)), 3e24),
        (Seq(three_m3.aL, three_m3 aL, three_m3 (aL)), 3e21),
        (Seq(three_m3.fL, three_m3 fL, three_m3 (fL)), 3e18),
        (Seq(three_m3.pL, three_m3 pL, three_m3 (pL)), 3e15),
        (Seq(three_m3.nL, three_m3 nL, three_m3 (nL)), 3e12),
        (Seq(three_m3.μL, three_m3 μL, three_m3 (μL)), 3e9),
        (Seq(three_m3.mL, three_m3 mL, three_m3 (mL)), 3e6),
        (Seq(three_m3.cL, three_m3 cL, three_m3 (cL)), 3e5),
        (Seq(three_m3.dL, three_m3 dL, three_m3 (dL)), 3e4),
        (Seq(three_m3.L , three_m3 L , three_m3 (L)) , 3e3),
        (Seq(three_m3.daL, three_m3 daL, three_m3 (daL)), 3e2),
        (Seq(three_m3.hL, three_m3 hL, three_m3 (hL)), 3e1),
        (Seq(three_m3.kL, three_m3 kL, three_m3 (kL)), 3.0),
        (Seq(three_m3.ML, three_m3 ML, three_m3 (ML)), 3e-3),
        (Seq(three_m3.GL, three_m3 GL, three_m3 (GL)), 3e-6),
        (Seq(three_m3.TL, three_m3 TL, three_m3 (TL)), 3e-9),
        (Seq(three_m3.PL, three_m3 PL, three_m3 (PL)), 3e-12),
        (Seq(three_m3.EL, three_m3 EL, three_m3 (EL)), 3e-15),
        (Seq(three_m3.ZL, three_m3 ZL, three_m3 (ZL)), 3e-18),
        (Seq(three_m3.YL, three_m3 YL, three_m3 (YL)), 3e-21),
