...
class USCustomaryUnitsSpec extends MultiverseCustomSpec {
  ...
  "US Customary Units" - {
    import org.waman.multiverse.unit.USCustomaryUnits._
  ...
  "Survey Units" - {
    import org.waman.multiverse.unit.USCustomarySurveyUnits._
  ...
  "Fluid Units" - {
    import org.waman.multiverse.unit.USCustomaryFluidUnits._
  ...
  "Dry Units" - {
    import org.waman.multiverse.unit.USCustomaryDryUnits._
