...
import org.waman.multiverse.unit.electromagnetism.{ElectricChargeUnitObjects, ElectricDipoleUnitObjects}
import org.waman.multiverse.unit.mechanics.{AngularMomentumUnits, EnergyUnitObjects, ForceUnitObjects}
...
class ConstantsSpec extends MultiverseCustomSpec {
  ...
  "Physical constants in CGS" in {
    ...
    import BasicUnits._
    import org.waman.multiverse.unit.basic.MassUnits.u
    import org.waman.multiverse.unit.basic.LengthUnits.a0
    import org.waman.multiverse.unit.MechanicalUnits._
    import org.waman.multiverse.unit.ElectromagneticUnits._
    // Exercise
    val conversions =
      Table(
        ("current", "expected"),
