...
import waman.multiverse.unit.BasicUnits.{min => _, _}
import waman.multiverse.unit.basic._

class USCustomaryUnitsSpec extends MultiverseCustomSpec {

  "US Customary Units" - {
    import waman.multiverse.unit.USCustomaryUnits._
    ...
    "Mass Units should have the correct values" in {
      import waman.multiverse.unit.basic.MassUnits._
      // Exercise
      val conversions =
        Table(
          // Avoirdupois
  ...
  "Survey Units" - {
    import waman.multiverse.unit.USCustomarySurveyUnits._
    ...
    "Area Units should have the correct values" in {
      import waman.multiverse.unit.basic.MetricAttributes._
      // Exercise
      val conversions =
        Table(
          ("area", "expected"),
  ...
  "Fluid Units" - {
    import waman.multiverse.unit.USCustomaryFluidUnits._
  ...
  "Dry Units" - {
    import waman.multiverse.unit.USCustomaryDryUnits._
