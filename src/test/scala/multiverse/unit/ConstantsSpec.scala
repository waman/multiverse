...
import multiverse.unit.Constants._
import multiverse.unit.basic.TimeUnitObjects
import multiverse.unit.electromagnetism.{ElectricChargeUnitObjects, ElectricDipoleUnitObjects}
import multiverse.unit.mechanics.{AngularMomentumUnits, EnergyUnitObjects, ForceUnitObjects}
...
class ConstantsSpec extends MultiverseCustomSpec {
  ...
  "Physical constants in CGS" in {
    ...
    import BasicUnits._
    import multiverse.unit.basic.MassUnits.u
    import multiverse.unit.basic.LengthUnits.a0
    import multiverse.unit.MechanicalUnits._
    import multiverse.unit.ElectromagneticUnits._
    // Exercise
    val conversions =
      Table(
        ("current", "expected"),
