...
import multiverse.unit.mechanics.EnergyUnits._
import multiverse.unit.thermodynamics.AbsoluteTemperatureUnits._
import multiverse.unit.thermodynamics.EntropyUnits._
...
class EntropySpec extends MultiverseCustomSpec {
  ...
  "Unit" - {
    ...
    "A entropy unit should have the proper dimension" in {
      // SetUp
      import multiverse.DimensionSymbol._
      // Exercise
