package multiverse.unit.radiometry
...
import multiverse.unit.radiometry.SpectralIrradianceUnitObjects.{jansky, solar_flux_unit}
import multiverse.unit.radiometry.SpectralIrradianceUnits._
