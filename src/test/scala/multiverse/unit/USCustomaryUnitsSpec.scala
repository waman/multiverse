...
class USCustomaryUnitsSpec extends MultiverseCustomSpec {
  ...
  "US Customary Units" - {
    ...
    "Mass Units should have the correct values" in {
      import multiverse.unit.basic.MassUnits._
      // Exercise
      val conversions =
        Table(
          // Avoirdupois
  ...
  "Survey Units" - {
    import multiverse.unit.USCustomarySurveyUnits._
    ...
    "Area Units should have the correct values" in {
      import multiverse.unit.basic.MetricAttributes._
      // Exercise
      val conversions =
        Table(
          ("area", "expected"),
  ...
  "Fluid Units" - {
    import multiverse.unit.USCustomaryFluidUnits._
  ...
  "Dry Units" - {
    import multiverse.unit.USCustomaryDryUnits._
