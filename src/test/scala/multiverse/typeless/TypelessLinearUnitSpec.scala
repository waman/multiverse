  ...
  "Unit" - {
    ...
    "Types" - {
      ...
      "Sample units should have the proper type" in {
        import multiverse.typeless.implicits._
        import multiverse.unit.ElectromagneticUnits.C
    ...
    "Properties" - {
      ...
      "the dimension property should have the proper value" in {
        import multiverse.{DimensionSymbol => DS}
        val conversions =
          Table(
            ("unit", "expected"),
            (Dimless, Map()),  // Dimless
